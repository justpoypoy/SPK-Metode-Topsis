...
<head>
    ...
    <title>SMP PGRI 35 SERPONG -  Login</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">SMP PGRI 35 SERPONG  -  MENU LOGIN</h3>
                    </div>
                     <?php echo $this -> session -> flashdata('pesan'); ?>
                    <div class="panel-body">
                        <form role="form" method="POST" action="<?= base_url('Login/form')?>">
                            <fieldset>
                                ...
                                <button type="submit" class="btn btn-lg btn-info btn-block" name="submit">LOGIN</button>
                            </fieldset>
                        </form>
                    </div>
                    <div class="panel-heading">
                        <h6><u>Sistem Pendukung Keputusan Menentukan Siswa Teladan</u></h6>
                    </div>
                </div>
            </div>
        </div>
