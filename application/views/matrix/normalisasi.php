    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <div class="box">
                ...
                <div class="box-body">
                    <table id="pref" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th width="5%"><?= strtoupper('no'); ?></th>
                                <th><?= strtoupper('nama'); ?></th>
            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="box-footer">
                        <a href="<?= site_url('seleksi-penilaian'); ?>" class="btn btn-danger">Back to list</a>
                    </div>
                </div>
            </div>
        </div>
