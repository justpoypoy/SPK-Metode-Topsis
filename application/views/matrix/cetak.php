    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    <table id="bobot" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th width="10%"><?= strtoupper('no'); ?></th>
                                <th><?= strtoupper('nama'); ?></th>
        ...
        <div class="col-xs-12">
            <div class="box">
                    <div class="box-footer">
                        <a href="<?= site_url('print-seleksi'); ?>" class="btn btn-primary pull-right" target="__blank"><i class="fa fa-file-pdf-o"></i>&nbsp;Cetak PDF</a>
                        <a href="<?= site_url('cetak-seleksi'); ?>" class="btn btn-danger pull-left"><i class="fa fa-backward"></i>&nbsp;Pilih Periode Lain</a>
                    </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-body">
                    Maaf data belum ada ...
                    <div class="box-footer">
                        <a href="<?= site_url('cetak-seleksi'); ?>" class="btn btn-danger">Back to list</a>
                    </div>
                </div>
            </div>
        </div>
